...
import qrCode2 from "../assets/qr-code2.png";
...
function QRCode() {
  ...
  const handleCopy = async () => {
    try {
      await navigator.clipboard.writeText("https://snap.link/share/a8f3k2");
      setCopied(true);
        ...
        <section style={{ width: "390px", maxWidth: "100%", height: "844px", background: "#000", borderRadius: "40px", border: "2px solid #2a2a35", overflow: "hidden", padding: "20px", boxSizing: "border-box" }}>
          ...
          <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column" }}>
            ...
            <div style={{ display: "flex", alignItems: "flex-start", gap: "16px", marginTop: "30px", marginBottom: "25px" }}>
              <Link to="/qr" style={{ background: "none", border: "none", cursor: "pointer" }}>
                <img src={retorno} alt="Voltar" style={{ width: "24px", height: "24px", filter: "brightness(0) invert(1)" }} />
              </Link>

              <div>
                <h2 style={{ margin: 0, color: "#9d4cff", fontSize: "18px", fontWeight: 700 }}>QR Compartilhar</h2>
                <span style={{ color: "#8a8a95", fontSize: "12px" }}>Compartilhe em qualidade original</span>
              </div>
            </div>

            <div style={{ width: "70%", height: "250px", margin: "0 auto", background: "#ececec", borderRadius: "18px", display: "flex", alignItems: "center", justifyContent: "center" }}>
              <img src={qrCode2} alt="QR Code" style={{ width: "180px", height: "180px" }} />
            </div>

            <div style={{ width: "100%", background: "#10131c", border: "1px solid #232632", borderRadius: "16px", padding: "14px", display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: "20px", boxSizing: "border-box" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "10px", minWidth: 0 }}>
                <img src={linkIcon} alt="Link" style={{ width: "18px", height: "18px", filter: "brightness(0) invert(1)" }} />
                <span style={{ color: "#d5d5dd", fontSize: "12px", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>https://snap.link/share/a8f3k2</span>
              </div>
            ...
            <button onClick={handleGenerate} style={{ marginTop: "18px", width: "100%", border: "none", borderRadius: "16px", padding: "16px", background: "linear-gradient(135deg,#a855f7,#7c3aed)", color: "#fff", fontSize: "16px", fontWeight: 600, cursor: "pointer" }}>
              {generated ? "Link Gerado ✓" : "Gerar novo link"}
            </button>
